    ...
    return (
        <>
            <div className="w-full ">
                <div>
                    <h2 className='text-[17px] font-semibold'>BEWAKOOF® THE NEW AGE ONLINE SHOPPING EXPERIENCE.</h2>
                ...
                <div>
                    ...
                    <p className='text-[15px] mt-5 '>
                        As for our accessories collection, they are also manufactured with impeccable quality materials. Our <span className='text-[#51CCCC]'>mobile covers</span> are made from hard and durable polycarbonate, with a matte finish that will make for a great protection for your phone with the rough use that we put them through nowadays.
                    </p>
                </div>
